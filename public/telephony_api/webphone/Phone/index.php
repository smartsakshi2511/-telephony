...
// echo "The server's IP address is: " . $server_ip;
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <!-- Provisioning -->
        <script type="text/javascript">
        //      const lineNumbers = localStorage.getItem('LineNumber') || '1';
        // console.log("Live Line Number:", lineNumbers);
        // window.parent.alertMyMessage(lineNumbers);

            // Provision runtime options can go here.
            function getPhoneOptions() {
        let urlParams = new URLSearchParams(window.location.search);
        let DND = urlParams.has("DND") ? urlParams.get("DND") : null;
        ...
        let phoneOptions = {
            ...
            Notifications: true,
            DoNotDisturbEnabled: DND ? DND === 'true' : false,
            profileName: "<?= $name ?>",
            wssServer: "<?= $server ?>",
        ...
        console.log("Phone Options: ", phoneOptions); // For debugging
        return phoneOptions;
    }

    // Call the function to get the phone options
    var phoneOptions = getPhoneOptions();
